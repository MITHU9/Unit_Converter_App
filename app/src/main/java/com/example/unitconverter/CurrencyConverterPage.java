        ...
        convertBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!value.isEmpty()){
                    ...
                    else if(item1.equals("USD") && item2.equals("BD")){
                        Double result = input_val * 105.97;
                        textView.setText(new DecimalFormat("##.##").format(result) + "Tk");
                    }
                    ...
                    else if(item1.equals("UK") && item2.equals("BD")){
                        Double result = input_val * 128.65;
                        textView.setText(new DecimalFormat("##.##").format(result) + "Tk");
                    }
                    ...
                    else if(item1.equals("Dubai") && item2.equals("BD")){
                        Double result = input_val * 28.86;
                        textView.setText(new DecimalFormat("##.##").format(result) + "Tk");
                    }
                   ...
                   // Malaysia currency convert
                    ...
                    else if(item1.equals("Malaysia") && item2.equals("BD")){
                    ...
                    else if(item1.equals("India") && item2.equals("BD")){
                        Double result = input_val * 1.28;
                        textView.setText(new DecimalFormat("##.##").format(result) + "Tk");
                    }
                    ...
                    else if(item1.equals("Pakistan") && item2.equals("BD")){
                    ...
                    else if(item1.equals("Qatar") && item2.equals("BD")){
                   ...
                   // Kuwait Currency convert
                    ...
                    else if(item1.equals("Kuwait") && item2.equals("BD")){
                        Double result = input_val * 346.02 ;
                        textView.setText(new DecimalFormat("##.##").format(result) + "Tk");
                    }
